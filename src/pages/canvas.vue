  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-10 col-md-offset-1">
        <div class="canvas">
          <!--<section>-->
            <!--<header><h1>画矩形</h1></header>-->
            <!--<canvas id="canvas21" width="400" height="300"></canvas>-->
          <!--</section>-->
          <!--<section>-->
            <!--<header><h1>清除矩形</h1></header>-->
            <!--<canvas id="canvas22" width="400" height="300"></canvas>-->
          <!--</section>-->

          <!--<section>-->
            <!--<header><h1>绘制路径</h1></header>-->
            <!--<canvas id="canvas23" width="400" height="300"></canvas>-->
          <!--</section>-->
          <!--<section>-->
            <!--<header><h1>画圆()</h1></header>-->
            <!--<canvas id="canvas0" width="400" height="300"></canvas>-->
          <!--</section>-->

          <!--<section>-->
            <!--<header><h1>画线test(lineTo moveTo)</h1></header>-->
            <!--<canvas id="canvas8" width="400" height="300"></canvas>-->
          <!--</section>-->
          <!--<section>-->
            <!--<header><h1>画线demo(lineTo moveTo)</h1></header>-->
            <!--<canvas id="canvas1" width="400" height="300"></canvas>-->
          <!--</section>-->

          <!--<section>-->
            <!--<header><h1>贝塞尔曲线test（bezierCurveTo）</h1></header>-->
            <!--<canvas id="canvas24" width="400" height="300"></canvas>-->
          <!--</section>-->
          <!--<section>-->
            <!--<header><h1>贝塞尔曲线demo（bezierCurveTo）</h1></header>-->
            <!--<canvas id="canvas2" width="400" height="300"></canvas>-->
          <!--</section>-->


          <!--<section>-->
            <!--<header><h1>线性test（createLinearGradient addColorStop）</h1></header>-->
            <!--<canvas id="canvas25" width="400" height="300"></canvas>-->
          <!--</section>-->
          <!--<section>-->
            <!--<header><h1>线性demo（createLinearGradient addColorStop）</h1></header>-->
            <!--<canvas id="canvas3" width="400" height="300"></canvas>-->
          <!--</section>-->

          <!--<section>-->
            <!--<header><h1>发散test（createRadialGradient）</h1></header>-->
            <!--<canvas id="canvas26" width="400" height="300"></canvas>-->
          <!--</section>-->
          <!--<section>-->
            <!--<header><h1>发散demo（createRadialGradient）</h1></header>-->
            <!--<canvas id="canvas4" width="400" height="300"></canvas>-->
          <!--</section>-->

          <!--<section>-->
            <!--<header><h1>平移 test（translate）缩放（scale） 旋转（rotate）</h1></header>-->
            <!--<canvas id="canvas5" width="400" height="300"></canvas>-->
          <!--</section>-->
          <!--<section>-->
            <!--<header><h1>平移 demo（translate）缩放（scale） 旋转（rotate）</h1></header>-->
            <!--<canvas id="canvas6" width="400" height="300"></canvas>-->
          <!--</section>-->
          <!--<section>-->
            <!--<header><h1>坐标与路径的结合使用</h1></header>-->
            <!--<canvas id="canvas7" width="400" height="300"></canvas>-->
          <!--</section>-->
          <!--<section>-->
            <!--<header><h1>矩阵变换</h1></header>-->
            <!--<canvas id="canvas9" width="400" height="300"></canvas>-->
          <!--</section>-->

          <!--<section>-->
            <!--<header><h1>图形组合叠加(globalCompositeOperation)</h1></header>-->
            <!--<canvas id="canvas10" width="400" height="300"></canvas>-->
          <!--</section>-->

          <!--<section>-->
            <!--<header><h1>给图像绘制阴影test shadowOffsetX(阴影的横向位移量) shadowOffsetY(盈盈的纵向位移量) shadowColor（阴影的颜色）-->
              <!--shadowBlur（阴影的模糊范围）</h1></header>-->
            <!--<canvas id="canvas27" width="400" height="300"></canvas>-->
          <!--</section>-->
          <!--<section>-->
            <!--<header><h1>给图像绘制阴影demo shadowOffsetX(阴影的横向位移量) shadowOffsetY(盈盈的纵向位移量) shadowColor（阴影的颜色）-->
              <!--shadowBlur（阴影的模糊范围）</h1></header>-->
            <!--<canvas id="canvas11" width="400" height="300"></canvas>-->
          <!--</section>-->

          <!--<section>-->
            <!--<header><h1>绘制图像drawImage(image,x,y)</h1></header>-->
            <!--<canvas id="canvas28" width="400" height="300"></canvas>-->
          <!--</section>-->
          <!--<section>-->
            <!--<header><h1>绘制图像drawImage(image,x,y,w,h)</h1></header>-->
            <!--<canvas id="canvas12" width="400" height="300"></canvas>-->
          <!--</section>-->
          <!--<section>-->
            <!--<header><h1>绘制局部图像drawImage(image,sx,sy,sw,sh,dx,dy,dw,dh)</h1></header>-->
            <!--<canvas id="canvas13" width="400" height="300"></canvas>-->
          <!--</section>-->

          <!--<section>-->
            <!--<header><h1>图像平铺</h1></header>-->
          ...
          <!--</section>-->
          <!--<section>-->
            <!--<header><h1>像素处理getImageData</h1></header>-->
  ...
  export default{
    compiled(){
      ...
      /*      var name = 'wang';
       ...
       var person_1 = new Person1("Alice0000", 29);
       //      var person_1=Person1("Alice0000",29);  //new 和不 new 的区别,新建对象和对象引用的区别
      ...
      /*//call apply bind 改变this
       ...
       sayName.call(person);
       this["iSay"].call(this, name);
       var say = sayName.bind(person);
       say();
       sayName();*/
      /*     //箭头函数 不创建自身this,取决于其在定义时的外部函数,并且不可修改
       var num=[1,2,3];
       (function(){
       var showNumber=()=>{
...
//            g2.addColorStop(1, 'rgba(0,0,255,0.5)');
      ...
      function draw12(id) {
        var image = new Image();
        image.src = "static/images/html5.jpg";
        var canvas = document.getElementById(id);
        if (canvas == null) return false;
        var context = canvas.getContext("2d");
        context.fillStyle = "#EEEEFF";
      ...
      function draw13(id) {
        ...
        context.fillRect(0, 0, 400, 300);
        image.onload = function () {
          context.drawImage(image, 100, 100, 200, 150, 50, 50, 300, 200);//取实际尺寸
        }
      }
      ...
      function draw14(id) {
        ...
        var i = 0;
        image.src = "static/images/wordslogo.jpg";
        image.onload = function () {
      ...
      function draw19(id){
        ...
        var w=window.open(canvas.toDataURL('image/jpeg'),"smallwin","width=500,height=400");
      }
      function draw20(id) {
        var canvas=document.getElementById(id);
        if(canvas==null) return false;
...
//        create5StarClip(context);
      ...
      function drawRoad(id){
        var image=new Image();
        image.src='static/images/road-cross-section.jpg';
        var canvas=document.getElementById(id);
        if(canvas==null) return false;
        var context=canvas.getContext('2d');
        context.fillStyle="#EEEEFF";
        context.fillRect(0,0,1012,445);
        image.onload=function () {
          context.drawImage(image,0,0);
        }
      }
