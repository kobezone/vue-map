...
<script>
    ...
    export default{
        ...
        ready(){
            ...
            dojoRequire(["dojo/parser",
                    ...
                    function (parser, Map, on, dom, has, Color, Units, bubblePopup, MeasureTools, TDTLayer, TDTImgLayer,
                        ...
                        var tianjinRoadMapLayer = new FeatureLayer(tianjinRoadSHP + "0", {
                        ...
                        var tianjinRoadLineLayer = new FeatureLayer(tianjinRoadUrl + "0", {
                            mode: FeatureLayer.MODE_ONDEMAND,
                            outFields: ['*'],
                        ...
                        var tianjinRoadPolyLayer = new FeatureLayer(tianjinRoadUrl + "1", {
                            mode: FeatureLayer.MODE_ONDEMAND,
                            outFields: ['*'],
                        ...
                        function showCoordinates(evt) {
                            var mp = evt.mapPoint;
                            $("#XYinfo").html("坐标：" + mp.x.toFixed(4) + " , " + mp.y.toFixed(4));  //t
                        }
                    });
        },
        data(){
        ...
        watch: {
            ...
            checkboxChecked: function (value, oldValue) {
                if (value) {
                    root.TDTAnnoLayer.show();
                } else {
